...
### Workforce analysis
df15 <- read.csv("../../data/workforce/raw/15_9.csv")
df23 <- read.csv("../../data/workforce/raw/23_9.csv")
...
Risk prediction models exist in clinical practice to identify individuals who are at risk of, for example, a cardiovascular event. We propose a similar model at the practice level to identify practice that are at risk of closure. To our knowledge, such a model does not exist at present.
