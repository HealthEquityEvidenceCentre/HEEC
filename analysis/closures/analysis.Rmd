...
We begin by defining the types of closures:
...
The NHS Payments data contains information on practice closures, under the column `Practice.Code.Date`. We can use this data to identify practices that have closed in the past decade.
...
# print number of closed practices
nrow(closure)
```
