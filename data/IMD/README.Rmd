...
### Direct download
However, this data only provides values for practice that are still active in 2019. To get the data for all practices, we can obtained the CSV directly from OHID via email, which is available [here](https://github.com/camappel/HEEC/blob/main/data/IMD/IMD_raw.csv) as `IMD_raw.csv`.
